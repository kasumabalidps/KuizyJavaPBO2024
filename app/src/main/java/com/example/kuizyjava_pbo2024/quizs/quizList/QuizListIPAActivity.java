...
public class QuizListIPAActivity extends AppCompatActivity {

    private static final String TAG = "QuizListIPA";

    /**
     * Initializes the QuizListIPAActivity, setting up the UI and fetching quiz data.
     * 
     * This method performs the following tasks:
     * - Sets up the activity's content view
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_ipaactivity);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(QuizListIPAActivity.this, QuizCategoryActivity.class);
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance("https://kuizy-pbo2024-default-rtdb.asia-southeast1.firebasedatabase.app/")
                .getReference("quiz/categories/ipa/quizzes");
     ...
     * and adds it to the grid layout. It also sets up a click listener for starting the quiz.
     * 
    ...
    private void startQuizActivity(String quizId, String quizName) {
        ...
        Intent intent = new Intent(QuizListIPAActivity.this, QuizActivity.class);
        intent.putExtra("quizId", quizId);
        intent.putExtra("quizName", quizName);
        intent.putExtra("category", "ipa");
        startActivity(intent);
    }
}
